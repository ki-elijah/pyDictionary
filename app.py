...
synonym = Label(root, text="", font=("Helvatica 10"), wraplength=800, justify="left", borderwidth=2, relief="ridge")
synonym.grid(row=5, column=1)
...
antonym = Label(root, text="", font=("Helvatica 10"), wraplength=800, justify="left", borderwidth=2, relief="ridge")
antonym.grid(row=7, column=1)
...
b = Button(root, text="Submit", font=("Helvatica 11 bold"), borderwidth=3, relief="raised", fg="white", bg="gray", command=dict)
